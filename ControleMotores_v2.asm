...
DELAY_400U
	;CORPO DA ROTINA1
	MOVLW	.115		;VALOR INICIAL DO DELAY2
	MOVWF	DELAY1
...
INICIO:
	...
	MOVWF	ADCON1
	MOVLW	B'00000111'	;MODULO COMPARADOR DESATIVADO
	MOVWF	CMCON
	CLRF	PORTA
...
ALTERA_PHI
	...
	CLRF	FIM_PERIODO	    ;LIMPA O SINALIZADOR DO TÉRMINO DO PERÍODO
	CALL	DELAY_400U	    ;PERMANECE POR 600USEGUNDOS
	MOVFF	PHI,CONTADOR_DELAY  ;MAIS PHI*12USEGUNDOS EM NÍVEL ALTO
	CALL	DELAY_AUXILIAR	    ;CONTADOR É INICIALIZADO COM O VALOR DO ÂNGULO
