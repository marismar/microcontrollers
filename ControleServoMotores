...
; PELO SISTEMA
	...
	CBLOCK	0x10		;ENDEREÇO INICIAL DA MEMÓRIA DE USUÁRIO
		...
		MELHOR_TETA	;MELHOR ÂNGULO TETA(SERVO MOTOR 1)
		MELHOR_PHI	;MELHOR ÂNGULO PHI(SERVO MOTOR 2)
		MAX_TENSAO	;MÁXIMA TENSÃO
		
		;VARIÁVEIS AUXILIARES PARA GERAÇÃO DE DELAY
		CONTADOR_DELAY	;AUXILIAR NA REPETIÇÃO DO DELAY DE 10USEGUNDOS
		CONTADOR_INT	;AUXILIAR NA MANUTENÇÃO DO MESMO ÂNGULO POR 600MSEGUNDOS
		DELAY1		
		DELAY2
		DELAY3
...
; INTERRUPÇÕES
	...
	DECFSZ	CONTADOR_INT		;DECREMENTA O CONTADOR
	GOTO	END_INT
	GOTO	ALTERA_ANGULO		
	
ALTERA_ANGULO
	INCF	TETA			;INCREMENTA O ÂNGULO
	;DECIDIR SE O ANGULO A SER INCREMENTADO É TETA OU PHI
	;LIMITAR ATÉ 180 GRAUS
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	...
	CLRF	PHI		;ANGULO INICIAL 0 GRAUS
...
MAIN
	...
	CLRF	WREG		;MAIS TETA*10USEGUNDOS EM NÍVEL ALTO
	MOVFF	TETA,CONTADOR_DELAY ;CONTADOR É INICIALIZADO COM O VALOR DO ÂNGULO
	CALL	DELAY_AUXILIAR
	BCF	LATA,RA1		;ATÉ O PERÍODO TERMINAR, RA1 = 0				
	GOTO	TERMINOU_PERIODO;AGUARDA O PERIODO DE 20MSEGUNDOS ACABAR 
	
	;LIMITAR ATÉ 180 GRAUS
	
TERMINOU_PERIODO
	;BTFSC	FIM_PERIODO	;1 - NAO ACABOU / 0 - ACABOU
	NOP
