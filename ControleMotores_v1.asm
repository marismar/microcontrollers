...
; INTERRUPÇÕES
	...
	INCF	THETA		;INCREMENTA O ÂNGULO
	MOVF	THETA,0		;COPIA O VALOR DE TETA PARA WORK
	SUBLW	.181		
	BTFSC	STATUS,Z	;TESTA SE TETA FOI INCREMENTADO A 181 GRAUS 
	CLRF	THETA		;SE TETA FOR 181, ENTAO TETA RETORNA A 0 GRAUS
...
DELAY_12U
	MOVLW	.46		;VALOR INICIAL DO DELAY2
	MOVWF	DELAY3		
...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	...
	CLRF	THETA		;ANGULO INICIAL 0 GRAUS
